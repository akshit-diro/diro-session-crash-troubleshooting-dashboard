...
export const sidebarLinks: SidebarLinkConfig[] = [
  // Infra / networking
  { component: 'infra_loadbalancer', key: 'newrelic', label: 'New Relic', href: 'https://onenr.io/0MRN5X4ZAwn' },

  // Gateway / core services
  { component: 'infra_gateway', key: 'newrelic', label: 'New Relic', href: 'https://onenr.io/0MRN5X4ZAwn' },

  // Booking engine
  { component: 'booking_engine', key: 'newrelic', label: 'New Relic', href: 'https://onenr.io/0MRN5X4ZAwn' },
  ...
  { component: 'diro_guac', key: 'newrelic', label: 'New Relic', href: 'https://onenr.io/0MRN5X4ZAwn' },
  { component: 'diro_guac', key: 'graylogs', label: 'Graylogs', href: 'https://graylog.dirolabs.com:9000' },

  // Terminal server
  { component: 'terminal_server', key: 'newrelic', label: 'New Relic', href: 'https://onenr.io/0MRN5X4ZAwn' },
  ...
  { component: 'an_python', key: 'newrelic', label: 'New Relic', href: 'https://onenr.io/0MRN5X4ZAwn' },
  ...
  { component: 'keepalive', key: 'newrelic', label: 'New Relic', href: 'https://onenr.io/0MRN5X4ZAwn' },
